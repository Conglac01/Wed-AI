...
/* ── Benefit cards (shared icon helper) ───────────────────── */
...
export function LoginPage() {
  ...
  return (
    <div className="grid grid-cols-1 px-4 lg:grid-cols-[1fr_1.5fr] lg:gap-12 lg:px-8 mx-auto max-w-[1400px] min-h-[calc(100vh-64px)]">
      {/* ═══ Form Section (left) ═══════════════════════════════ */}
      <section
        className="flex min-h-full items-center justify-center px-4 py-12 lg:px-8"
      ...
      >
        <div className="w-full max-w-[480px]">
          ...
          <div className="mb-8">
            ...
            >
              Đăng nhập để tiếp tục khám phá hàng ngàn cơ hội việc làm phù
              hợp với bạn.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <label className="flex cursor-pointer items-center gap-2">
              <input
                ...
                className="h-4 w-4 rounded accent-[#1E5FD4]"
              />
      ...
      <section className="flex flex-col justify-start bg-white px-4 py-12 pt-20 lg:px-8 lg:py-16 lg:pt-20">
        <div className="mx-auto w-full max-w-[560px]">
          ...
          <h2
            ...
            style={{ fontSize: "20px" }}
          >
            Đăng nhập để truy cập ngay vào{" "}
            <span style={{ color: "#1E5FD4" }}>
              hàng ngàn cơ hội việc làm IT chất lượng
            </span>
          </h2>
          ...
          <div className="mt-10 space-y-4">
            <BenefitCard
              ...
              desc="Tiếp cận hàng ngàn vị trí IT từ các công ty uy tín đang tuyển dụng."
            />
            ...
            <BenefitCard
              ...
              title="Hồ sơ cá nhân chuyên nghiệp"
              desc="Tạo và quản lý hồ sơ ấn tượng, nổi bật với nhà tuyển dụng để đăng ký."
            />
            ...
            <BenefitCard
              ...
              title="Quản lý ứng tuyển hiệu quả"
              desc="Theo dõi và quản lý các công việc bạn đã ứng tuyển một cách hiệu quả."
            />
          </div>
